<nav class="u-site-width">
  <ol class="c-breadcrumbs">
    ...
    <?php elseif(is_post_type_archive('photo')): ?>
      <li class="c-breadcrumbs__item"><a href="<?php echo get_permalink( get_page_by_path(album)->ID); ?>"><span>写真一覧</span></li>
    ...
    <?php elseif(is_singular('office')) :?>
      ...
      <li class="c-breadcrumbs__item"><?php get_the_title(); ?>
      </li>
    <!-- タグ -->
    <?php elseif(is_tag()) : ?>
      <li class="c-breadcrumbs__item">
